---
name: bulk-rename
description: Rename many nodes at once following a naming convention. Use when layer names are inconsistent, auto-generated, or need a prefix/pattern applied across a page.
---
