---
name: swap-instance-overrides
description: Copy component instance overrides from a source instance to other instances. Use when swapping components or propagating text, fill, and nested overrides across instances.
---
