...
description: Convert manual numbered or lettered annotation markers into Figma native annotations. Use when a design documents specs with text markers that should become real annotations.
---
