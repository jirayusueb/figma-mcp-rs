---
name: read-design-strategy
description: Read a Figma design efficiently with figma-mcp-rs. Use when exploring an unfamiliar file, inspecting a frame or component, or deciding which read tool and detail level to call.
---

# Read Design Strategy

To effectively read a Figma design with figma-mcp-rs:
