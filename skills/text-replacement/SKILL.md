...
description: Systematically replace text across a Figma design. Use when localising copy, swapping placeholder text, or doing a chunked find-and-replace over many text nodes.
---
