---
name: generate-type-scale
description: Generate a complete typography scale as Figma text styles from a base font and size. Use when setting up heading/body styles or replacing ad-hoc font sizes with a ratio-based scale.
---
