...
description: Extract raw values from an existing design and build a structured variable and style token system. Use when bootstrapping design tokens or formalising an ad-hoc design into variables.
---
